...
with open(path_prefix + 'sample_validation.jar','rb') as f:
	sample_validation = pickle.load(f)
with open(path_prefix + 'target_validation.jar','rb') as f:
	target_validation = pickle.load(f)
with open(path_prefix + 'target_adversarial_validation.jar','rb') as f:
	target_adversarial_validation = pickle.load(f)
with open(path_prefix + 'model_prediction.jar','rb') as f:
	model_prediction = pickle.load(f)
history_dict = pickle.load(open(path_prefix + 'history_dict.jar','rb'))
adversary_history_dict = pickle.load(open(path_prefix + 'adversary_history_dict.jar','rb'))
with open('l_test.jar','rb') as f:
	l_test = pickle.load(f)
with open('l_train.jar','rb') as f:
	l_train = pickle.load(f)
with open('tpr.jar','rb') as f:
	tpr = pickle.load(f)
with open('fpr.jar','rb') as f:
	fpr = pickle.load(f)
with open('auc.jar','rb') as f:
	auc = pickle.load(f)
...
def plot_sep_all():
	...
	plt.gcf().savefig('separation_discriminator.png')
	#plt.show()
	plt.gcf().clear()
...
def plot_roc():
	...
	plt.plot(fpr, tpr, 'g--', label='$AUC_{train}$ = %0.2f'% auc)
...
def plot_accuracy():
	plt.plot(history_dict['binary_accuracy'])
	plt.plot(history_dict['val_binary_accuracy'])
	plt.title('model accuracy')
	plt.ylabel('accuracy')
	plt.xlabel('epoch')
	plt.legend(['train', 'test'], loc='upper left')
	#plt.show()
	plt.gcf().savefig('acc.png')
	plt.gcf().clear()
